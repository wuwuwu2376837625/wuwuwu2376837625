...
<div class="htmleaf-container">
    <div class="wrapper">
        <div class="container">
            <div class="box">
                <form action="TeRegist.do" method="post">
                    <table border="1">
                            <tr>
                                <td>教师编号</td>
                                <td><input type="text" name="No" id="No" placeholder="请输入10位数字以内的账号"  maxlength="10"></td>
                            </tr>
                            <tr>
                                <td>姓名</td>
                            ...
                            <tr>
                                <td colspan="2"><a href="TeLogin.jsp">已有帐号？点击登录</a></td>
                            </tr>
                    </table>
                </form>
            </div>
